...
/* package stmonads-0.1.0.0 */
#define VERSION_stmonads "0.1.0.0"
#define MIN_VERSION_stmonads(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "stmonads-0.1.0.0-F0fkbhtpFGPG8S93KJSRcL"

#define CURRENT_PACKAGE_KEY "stmonads-0.1.0.0-F0fkbhtpFGPG8S93KJSRcL"
